...
import {setDialogComponent,handleClose} from "./redux/dialogActions"
...
export default function AppDialog ()  {
  ...
  return (
    ...
    <div id="dialog_footer">
      <Button className="app_button" style={{width:"40%"}} onClick={() => dispatch(handleClose())}>Cancel</Button>
      <Button className="app_button" style={{width:"40%",marginLeft:"15%"}} onClick={() => dispatch(DialogState.onSave)}>{DialogState.okButton}</Button>
    </div>:null
    }
    </DialogContent>
  </Dialog>
